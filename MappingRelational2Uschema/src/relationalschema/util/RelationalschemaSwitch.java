 ...
 * @generated
 */
public class RelationalschemaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelationalschemaPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalschemaPackage.RELATIONAL_SCHEMA: {
				RelationalSchema relationalSchema = (RelationalSchema)theEObject;
				T result = caseRelationalSchema(relationalSchema);
				if (result == null) result = caseNamedElement(relationalSchema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalschemaPackage.TABLE: {
			...
			case RelationalschemaPackage.COLUMN: {
			...
			case RelationalschemaPackage.KEY: {
				Key key = (Key)theEObject;
				T result = caseKey(key);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalschemaPackage.FKEY: {
