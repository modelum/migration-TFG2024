...
public class Main {
  private static final String INPUT_XMI_PATH = "input-files/USchema_integration.xmi";

  private static final String OUTPUT_XMI_PATH = "output-files/Document_integration.xmi";
