 ...
 * </p>
 * <ul>
 *   <li>{@link documentschema.impl.PrimitiveTypeImpl#getDatatype <em>Datatype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType {
	...
	protected EClass eStaticClass() {
		return DocumentschemaPackage.Literals.PRIMITIVE_TYPE;
	}
	...
	public void setDatatype(DataType newDatatype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentschemaPackage.PRIMITIVE_TYPE__DATATYPE, oldDatatype, datatype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocumentschemaPackage.PRIMITIVE_TYPE__DATATYPE:
				return getDatatype();
		}
