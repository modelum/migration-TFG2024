...
public class EntityTypeImpl extends MinimalEObjectImpl.Container implements EntityType {
	...
	protected EClass eStaticClass() {
		return DocumentschemaPackage.Literals.ENTITY_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentschemaPackage.ENTITY_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocumentschemaPackage.ENTITY_TYPE__NAME:
				return getName();
			case DocumentschemaPackage.ENTITY_TYPE__PROPERTIES:
